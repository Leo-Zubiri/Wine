...
from Medidas_Similitud import Euclidiana,Euclidiana_norm,Manhattan,Jaccard,Coseno,Sorence_Dice
from statistics import multimode


metricas = [Manhattan,Euclidiana,Euclidiana_norm,Jaccard,Coseno,Sorence_Dice]
